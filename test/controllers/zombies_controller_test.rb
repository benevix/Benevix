...
class ZombiesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zombie" do
    assert_difference('Zombie.count') do
      post zombies_url, params: { zombie: { apodrecendo: @zombie.apodrecendo, bio: @zombie.bio, idade: @zombie.idade, nascimento: @zombie.nascimento, nome: @zombie.nome, salario: @zombie.salario, zombification: @zombie.zombification } }
    end
  ...
  test "should update zombie" do
    patch zombie_url(@zombie), params: { zombie: { apodrecendo: @zombie.apodrecendo, bio: @zombie.bio, idade: @zombie.idade, nascimento: @zombie.nascimento, nome: @zombie.nome, salario: @zombie.salario, zombification: @zombie.zombification } }
